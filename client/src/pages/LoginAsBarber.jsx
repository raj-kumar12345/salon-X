...
import { FiMail, FiLock, FiLoader, FiScissors } from "react-icons/fi";
...
const LoginAsBarber = () => {
  ...
  return (
    ...
    >
      ...
      {/* Decorative Glow */}
      <div className="absolute bottom-1/4 left-1/4 w-72 h-72 bg-amber-600/10 rounded-full blur-[120px] -z-10" />
      ...
      <div className="w-full max-w-[360px] bg-white/5 backdrop-blur-2xl p-8 rounded-[2.5rem] shadow-2xl border border-white/10 relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-white tracking-tight">
            Barber <span className="text-amber-500">Portal</span>
          </h1>
          <p className="text-gray-500 text-[10px] uppercase tracking-[0.2em] font-bold mt-2">Manage your studio</p>
        </div>
